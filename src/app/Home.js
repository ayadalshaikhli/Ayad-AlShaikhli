      ...
      <section id="about" className="secound-section showreel">
        <div className="about" ref={(el) => (about = el)}>
          ...
          <div className="about-me col-lg-8 col-md-12">
            <p className="text-1">
              Full Stack Web Developer leveraging a background in design and
              video editing to develop code that is clear and efficient in both
              design and execution.
            </p>
            <p className="text-1">
              Earned a certificate in Full Stack Web Development from the UC
              Davis Coding Bootcamp. I’m passionate about coding because it
              allows me to be creative and innovate solutions to real-world
              problems. Technical skills include Git, HTML3, CSS5, JavaScript,
              Node.js, React, MySQL, GSAP and MongoDB. Strengths in problem
              solving, time management, being detail-oriented and keeping my
              teams on track to meet deadlines. I’m excited to expand my skills
              and knowledge as a developer in my next role.
            </p>
          </div>
        </div>
      </section>
